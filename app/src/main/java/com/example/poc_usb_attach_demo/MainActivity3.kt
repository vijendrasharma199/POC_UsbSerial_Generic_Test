...
import com.example.poc_usb_attach_demo.databinding.ActivityMain3Binding
import com.example.poc_usb_attach_demo.databinding.ActivityMainBinding

class MainActivity3 : AppCompatActivity(), UsbHelperListener {
    private var TAG = "TAGS_NAME"
